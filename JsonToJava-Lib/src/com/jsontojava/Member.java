...
public class Member {
	...
	public static class Builder {
		...
		private boolean mShouldUseArrayInsteadOfList;
		...
		public Member.Builder setShouldUseArrayInsteadOfList(boolean shouldUseArrayInsteadOfList){
			mShouldUseArrayInsteadOfList = shouldUseArrayInsteadOfList;
			return this;
		}
		...
		public Member.Builder setPlural(){
			mPlural = true;
			if(mType != null){
				mType = getArrayOrListType(mType);
			}
			if(mName != null){
		...
		private String getArrayOrListType(String type) {
			return mShouldUseArrayInsteadOfList ? type + "[]" : "List<"+type+">";
		}
